...
$(function(){
    ...
    optionData.url = "{!! route('standardRQC.selectAllStandardRQCs', []) !!}";
    optionData.id = "#standard_r_q_c_id";
            ...
            */
            ...
            //}else{
                ...
                .always(function() {
                    ...
                    /*$( optionData.id ).val( element_value_temp );
                    $( optionData.id ).trigger("change");
                    
                    console.log( $( optionData.id ).val() );
