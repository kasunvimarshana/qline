...
$(function(){
    ...
    optionData.id = "#id";
    optionData.id_prefix = "defect_element_id";
    
    optionData.id_prefix_defect_category = "defect_category_element_id";
    
    var form_hidden_input_group_0 = $("#form1_hidden_input_group");
    var form_hidden_input_group_1 = $("#form1_hidden_input_group_child_3_3_1_1");
    var form_hidden_input_group_2 = $("#form1_hidden_input_group_child_3_3_2_1");
    ...
    */
    ...
    window.ajaxRequest_Defect = ajaxRequest_ = function(){
        var request = $.ajax({
            url: optionData.url,
            cache: false,
            quietMillis: 10,
            ...
            data : {
                //'key': 'value',
                'defect_category_id': $(document).getMyStorageData( optionData.id_prefix_defect_category ),
            },
            ...
            request.done(function(data) {
                ...
                if( (data_data == void(0)) || (data_data.length <= 0) ){
                    ...
                    $.each(data_data, function(index, value){
                        ...
                        if( (value.defect_category) ){
                            var defect_category = value.defect_category;
