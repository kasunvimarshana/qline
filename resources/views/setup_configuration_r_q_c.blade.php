                                            ...
                                            <div class="col col-sm-12 row p-0 m-0">
                                                ...
                                                <div class="form-group row col-sm-6">
                                                    ...
                                                    <div class="col">
                                                        <!-- p class="form-control-static"></p -->
                                                        <div class="input-group h-100">
                                                            <select class="form-control form-control-md select2" id="standard_r_q_c_id" name="standard_r_q_c_id" value="{{ old('standard_r_q_c_id') }}" autocomplete="off" data-placeholder="RQC" style="width: 100%;" required="required" data-minimum-results-for-search="Infinity">
                                                                <!-- option> Option </option -->
                                                            </select>
                                                        </div>
                                                    </div>
