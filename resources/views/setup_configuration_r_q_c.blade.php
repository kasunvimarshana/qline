                ...
                <div class="card bg-secondary border-light">
                    <div class="card-header" id="idCard_accordion_1_content_1">
                        <h5 class="mb-0">
                            ...
                            <span class="text-decoration-none text-justify small"> Stup ( RQC )</span>
                            </button>
                        </h5>
                    </div>
                    ...
                    <div id="idCollapse_accordion_1_content_1" class="collapse show" aria-labelledby="idCard_accordion_1_content_1" data-parent="#idCollapse_accordion_1_content_1">
                        <div class="card-body bg-light" id="idCollapse_content_1_body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <!-- form -->
                                    <form action="{!! route('setupConfigurationRQC.store', []) !!}" method="POST" class="col col-sm-12" autocomplete="off" id="form1" enctype="multipart/form-data">
                                        @csrf
                                        <!-- form-group-row -->
                                            ...
                                            <div class="col col-sm-12 row p-0 m-0">
                                                ...
                                                <div class="form-group row col-sm-6">
                                                    ...
                                                    <div class="col">
                                                        <!-- p class="form-control-static"></p -->
                                                        <div class="input-group h-100">
                                                            <select class="form-control form-control-md select2" id="standard_r_q_c_id" name="standard_r_q_c_id" value="{{ old('standard_r_q_c_id') }}" data-placeholder="RQC" style="width: 100%;" required="required">
                                                                <!-- option> Option </option -->
                                                            </select>
                                                        </div>
                                                    </div>
...
<script>
    $(function(){
        "use strict";
        @php
            $setup_configuration_standard_r_q_c_id = null;
            if( (session()->has('setup_configuration_standard_r_q_c_id')) && (session()->exists('setup_configuration_standard_r_q_c_id')) ){
                $setup_configuration_standard_r_q_c_id = session()->get('setup_configuration_standard_r_q_c_id', null);
            }else if( (old('standard_r_q_c_id')) ){
                $setup_configuration_standard_r_q_c_id = old('standard_r_q_c_id');
            }else{
                $setup_configuration_standard_r_q_c_id = null;
            }
        @endphp
        $("#standard_r_q_c_id").select2("trigger", "select", {
            data: { id: "{!! $setup_configuration_standard_r_q_c_id !!}" }
        });
    });
</script>
@endpush
