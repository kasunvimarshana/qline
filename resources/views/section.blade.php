                                    ...
                                    <form action="{!! route('home') !!}" method="POST" class="col col-sm-8" autocomplete="off" id="form1" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group row col-sm-12 m-1">
                                                ...
                                                <div class="col">
                                                    <!-- p class="form-control-static"></p -->
                                                    <select class="form-control form-control-md select2" id="department" name="department" value="{{ old('department') }}" autocomplete="off" data-placeholder="Department" style="width: 100%;" required="required">
