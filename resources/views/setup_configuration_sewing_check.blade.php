                                            ...
                                            <div class="col col-sm-12 row p-0 m-0">
                                                ...
                                                <div class="form-group row col-sm-6">
                                                    ...
                                                    <div class="col">
                                                        <!-- p class="form-control-static"></p -->
                                                        <div class="input-group h-100">
                                                            <select class="form-control form-control-md select2" id="line_id" name="line_id" value="{{ old('line_id') }}" data-placeholder="Line" style="width: 100%;" required="required">
                                                                <!-- option> Option </option -->
                                                            </select>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col col-sm-12 row p-0 m-0">
                                                ...
                                                <div class="form-group row col-sm-6">
                                                    ...
                                                    <div class="col">
                                                        <!-- p class="form-control-static"></p -->
                                                        <div class="input-group h-100">
                                                            <select class="form-control form-control-md select2" id="standard_sewing_check_id" name="standard_sewing_check_id" value="{{ old('standard_sewing_check_id') }}" data-placeholder="SC 100%" style="width: 100%;" required="required">
                                                                <!-- option> Option </option -->
                                                            </select>
                                                        </div>
                                                    </div>
