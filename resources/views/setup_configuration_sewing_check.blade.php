                ...
                <div class="card bg-secondary border-light">
                    <div class="card-header" id="idCard_accordion_1_content_1">
                        <h5 class="mb-0">
                            ...
                            <span class="text-decoration-none text-justify small"> Stup ( SC 100% )</span>
                            </button>
                        </h5>
                    </div>
                    ...
                    <div id="idCollapse_accordion_1_content_1" class="collapse show" aria-labelledby="idCard_accordion_1_content_1" data-parent="#idCollapse_accordion_1_content_1">
                        <div class="card-body bg-light" id="idCollapse_content_1_body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <!-- form -->
                                    <form action="{!! route('setupConfigurationSewingCheck.store', []) !!}" method="POST" class="col col-sm-12" autocomplete="off" id="form1" enctype="multipart/form-data">
                                        @csrf
                                        <!-- form-group-row -->
                                        ...
                                        <div class="row col border border-danger rounded shadow-sm pr-5 m-1">
                                            ...
                                            <div class="container mt-3 mb-3">
                                                ...
                                                <h5 class="text-danger"> Customer </h5>
                                            </div>
                                            <!-- /.container -->
                                            <!-- form-group-col -->
                                            <div class="col col-sm-12 row p-0 m-0">
                                            ...
                                            <div class="col col-sm-12 row p-0 m-0">
                                                ...
                                                <div class="form-group form-group-lg row col-sm-6">
                                                    ...
                                                    <div class="col">
                                                        <!-- p class="form-control-static"></p -->
                                                        <div class="input-group h-100">
                                                            <select class="form-control form-control-lg select2" id="standard_sewing_check_id" name="standard_sewing_check_id" value="{{ old('standard_sewing_check_id') }}" autocomplete="off" data-placeholder="SC 100%" style="width: 100%;" required="required" data-minimum-results-for-search="Infinity">
                                                                <!-- option> Option </option -->
                                                            </select>
                                                        </div>
                                                    </div>
    ...
    $(function(){
        ...
        @php
            ...
            if( (session()->has('setup_configuration_line_id')) && (session()->exists('setup_configuration_line_id')) ){
                ...
                $setup_configuration_line_id = old('line_id');
            }else{
                $setup_configuration_line_id = null;
            }
        @endphp
...
<script>
    $(function(){
        "use strict";
        @php
            $setup_configuration_customer_id = null;
            if( (session()->has('setup_configuration_customer_id')) && (session()->exists('setup_configuration_customer_id')) ){
                $setup_configuration_customer_id = session()->get('setup_configuration_customer_id', null);
            }else if( (old('customer_id')) ){
                $setup_configuration_customer_id = old('customer_id');
            }else{
                $setup_configuration_customer_id = null;
            }
        @endphp
        $("#customer_id").select2("trigger", "select", {
            data: { id: "{!! $setup_configuration_customer_id !!}" }
        });
    });
</script>
@endpush
...
<script>
    $(function(){
        "use strict";
        @php
            $setup_configuration_colour_id = null;
            if( (session()->has('setup_configuration_colour_id')) && (session()->exists('setup_configuration_colour_id')) ){
                $setup_configuration_colour_id = session()->get('setup_configuration_colour_id', null);
            }else if( (old('colour_id')) ){
                $setup_configuration_colour_id = old('colour_id');
            }else{
                $setup_configuration_colour_id = null;
            }
        @endphp
        $("#colour_id").select2("trigger", "select", {
            data: { id: "{!! $setup_configuration_colour_id !!}" }
        });
    });
</script>
@endpush
...
<script>
    $(function(){
        "use strict";
        @php
            $setup_configuration_export_id = null;
            if( (session()->has('setup_configuration_export_id')) && (session()->exists('setup_configuration_export_id')) ){
                $setup_configuration_export_id = session()->get('setup_configuration_export_id', null);
            }else if( (old('export_id')) ){
                $setup_configuration_export_id = old('export_id');
            }else{
                $setup_configuration_export_id = null;
            }
        @endphp
        $("#export_id").select2("trigger", "select", {
            data: { id: "{!! $setup_configuration_export_id !!}" }
        });
    });
</script>
@endpush
...
<script>
    $(function(){
        "use strict";
        @php
            $setup_configuration_standard_sewing_check_id = null;
            if( (session()->has('setup_configuration_standard_sewing_check_id')) && (session()->exists('setup_configuration_standard_sewing_check_id')) ){
                $setup_configuration_standard_sewing_check_id = session()->get('setup_configuration_standard_sewing_check_id', null);
            }else if( (old('standard_sewing_check_id')) ){
                $setup_configuration_standard_sewing_check_id = old('standard_sewing_check_id');
            }else{
                $setup_configuration_standard_sewing_check_id = null;
            }
        @endphp
        $("#standard_sewing_check_id").select2("trigger", "select", {
            data: { id: "{!! $setup_configuration_standard_sewing_check_id !!}" }
        });
    });
</script>
@endpush
...
<script>
    $(function(){
        "use strict";
        $("#standard_sewing_check_id").select2("trigger", "select", {
            data: { id: "3135373235313232343062323833396334342d336437612d343864642d613733362d633538613236313739393136" }
        });
    });
</script>
@endpush
