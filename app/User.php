...
class User extends Authenticatable
{
     ...
     * @var array
     */
    protected $fillable = array('id', 'is_visible', 'is_active', 'code', 'code_epf', 'name_first', 'name_last', 'phone_mobile', 'password', 'display_name', 'image_uri', 'email', 'company_id', 'strategic_business_unit_id', 'department_id', 'section_id', 'grade', 'remember_token', 'code_active', 'is_token_authentication');
