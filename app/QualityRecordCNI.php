...
class QualityRecordCNI extends Model
{
    //
    ...
    */
    ...
    //one to many
    public function qualityRecordDataCNI(){
        return $this->hasMany('App\QualityRecordDataCNI', 'quality_record_c_n_i_id', 'id');
    }
