...
use Mail;
use App\Mail\InputScanDataQuantitySewingAuditMail;
use App\Line;
use App\User;
use \Exception;

class SendMessageSewingAuditJob implements ShouldQueue
{
    ...
    */
    ...
    public function handle()
    {
        ...
        $lineMetaDataObject = $lineObject->lineMetaData()
            ...
            ->where("data_key", "=", "user_id_stage_sewing_audit")->first();
        ...
        //send mail
        try{
            if( (isset($qualityRecordInputScanData)) && ($userObject) ){
                ...
                Mail::to($toUserArray)
                    ...
                    //->cc($ccUserArray)
                    //->bcc($ccUserArray)
                    ->send(new InputScanDataQuantitySewingAuditMail($qualityRecordInputScanData));
            }
        }catch(Exception $e){}
    }
