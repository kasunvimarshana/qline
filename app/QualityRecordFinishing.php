...
class QualityRecordFinishing extends Model
{
    //
    ...
    */
    ...
    //one to many
    public function qualityRecordDataFinishing(){
        return $this->hasMany('App\QualityRecordDataFinishing', 'quality_record_finishing_id', 'id');
    }
