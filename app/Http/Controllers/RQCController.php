...
class RQCController extends Controller
{
    ...
    public function index(Request $request){
        ...
        if(view()->exists('setup_configuration_r_q_c')){
            return View::make('setup_configuration_r_q_c', array());
        }else{
    ...
    public function store(Request $request){
        ...
        if( ($request->has('standard_r_q_c_id')) && ($request->filled('standard_r_q_c_id')) ){
            $standard_r_q_c_id = $request->input('standard_r_q_c_id', null);
        ...
        if( ($request->has('inspection_stage_id')) && ($request->filled('inspection_stage_id')) ){
            ...
            $inspectionStageObject = $inspectionStageObject->where('code', '=', 'RQC')->first();
