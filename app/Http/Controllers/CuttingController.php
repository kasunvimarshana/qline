...
class CuttingController extends Controller
{
    ...
    public function index(Request $request){
        ...
        if(view()->exists('setup_configuration_cutting')){
            return View::make('setup_configuration_cutting', array());
        }else{
    ...
    public function store(Request $request){
        ...
        if( ($request->has('inspection_stage_id')) && ($request->filled('inspection_stage_id')) ){
            ...
            $inspectionStageObject = $inspectionStageObject->where('code', '=', 'Cutting')->first();
