...
class SewingCheckController extends Controller
{
    ...
    public function index(Request $request){
        ...
        if(view()->exists('setup_configuration_sewing_check')){
            return View::make('setup_configuration_sewing_check', array());
        }else{
    ...
    public function store(Request $request){
        ...
        if( ($request->has('standard_sewing_check_id')) && ($request->filled('standard_sewing_check_id')) ){
            $standard_sewing_check_id = $request->input('standard_sewing_check_id', null);
        ...
        if( ($request->has('inspection_stage_id')) && ($request->filled('inspection_stage_id')) ){
            ...
            $inspectionStageObject = $inspectionStageObject->where('code', '=', 'SC 100%')->first();
