...
class CreateQualityRecordSewingAuditInputScanDataTable extends Migration
{
    protected $table_name_1 = "quality_record_sewing_audit_input_scan_data";
    /**
     * Run the migrations.
     *
     * @return void
    ...
    public function up()
    {
        Schema::create($this->table_name_1, function (Blueprint $table) {
            ...
            */
            ...
            $table->unsignedBigInteger('quality_record_sewing_audit_id')->nullable()->comment('comment');//->index()
