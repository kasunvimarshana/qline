...
class CreateQualityRecordDataFinishingsTable extends Migration
{
    protected $table_name_1 = "quality_record_data_finishings";
    /**
     * Run the migrations.
     *
     * @return void
    ...
    public function up()
    {
        Schema::create('quality_record_data_finishings', function (Blueprint $table) {
            /*
            ...
            */
            ...
            $table->unsignedBigInteger('quality_record_finishing_id')->unsigned()->nullable()->comment('comment');//->index()
            ...
            //$table->text('description')->default(null)->nullable()->comment('comment');
            $table->unsignedBigInteger('quality_record_data_finishing_id_parent')->unsigned()->nullable()->comment('comment');//->index()
        ...
        Schema::table($this->table_name_1, function($table) {
            ...
            //$table->primary(array('id'), ('pk'.time().Str::uuid()->toString()));
            $table->foreign('quality_record_finishing_id', ('fk'.time().Str::uuid()->toString()))->references('id')->on('quality_record_finishings')->onUpdate('cascade')->onDelete('cascade');
            ...
            $table->index(array('quality_record_finishing_id'), ('index'.time().Str::uuid()->toString()));
